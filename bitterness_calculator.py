...
class BitternessCalculator:
    ...
    def calc_hops_additions(self, plato: float, volume: float, target_ibu: float, hops: list[BoilHop]) -> list[Dict]:
        ...
        for hop in hops:
            ...
            logger.debug(
                ...
                hop.name, hop.percent, boil_time, alpha_acid, grams,
            )
